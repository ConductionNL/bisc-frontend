...
export type EmployeeQuery = (
  ...
  & { employee?: Maybe<(
    { __typename?: 'Employee' }
    & Pick<Employee, 'id' | 'person' | 'organization'>
  )> }
);
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    createEmployee(variables: CreateEmployeeMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CreateEmployeeMutation> {
      return withWrapper(() => client.request<CreateEmployeeMutation>(print(CreateEmployeeDocument), variables, requestHeaders));
    },
    deleteEmployee(variables: DeleteEmployeeMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DeleteEmployeeMutation> {
      return withWrapper(() => client.request<DeleteEmployeeMutation>(print(DeleteEmployeeDocument), variables, requestHeaders));
    },
    employee(variables: EmployeeQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<EmployeeQuery> {
      return withWrapper(() => client.request<EmployeeQuery>(print(EmployeeDocument), variables, requestHeaders));
    },
    employees(variables?: EmployeesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<EmployeesQuery> {
      return withWrapper(() => client.request<EmployeesQuery>(print(EmployeesDocument), variables, requestHeaders));
    }
  };
}
