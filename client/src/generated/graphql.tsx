...
export type CreateLanguageHouseMutation = (
  { __typename?: 'Mutation' }
  & { createLanguageHouse?: Maybe<(
    { __typename?: 'createLanguageHousePayload' }
    & Pick<CreateLanguageHousePayload, 'clientMutationId'>
    & { languageHouse?: Maybe<(
      { __typename?: 'LanguageHouse' }
      & Pick<LanguageHouse, 'id' | 'name' | 'address' | 'email' | 'phoneNumber' | 'type'>
    )> }
  )> }
);
...
export type CreateProviderMutation = (
  ...
  & { createProvider?: Maybe<(
    { __typename?: 'createProviderPayload' }
    & Pick<CreateProviderPayload, 'clientMutationId'>
    & { provider?: Maybe<(
      { __typename?: 'Provider' }
      & Pick<Provider, 'id' | 'name' | 'address' | 'email' | 'phoneNumber' | 'type'>
    )> }
  )> }
);
...
export type LoginUserMutation = (
  ...
  & { loginUser?: Maybe<(
    { __typename?: 'loginUserPayload' }
    & Pick<LoginUserPayload, 'clientMutationId'>
    & { user?: Maybe<(
      { __typename?: 'User' }
      & Pick<User, 'email' | 'id' | 'password' | 'token' | 'username'>
    )> }
  )> }
);
...
export type RequestPasswordResetUserMutation = (
  { __typename?: 'Mutation' }
  & { requestPasswordResetUser?: Maybe<(
    { __typename?: 'requestPasswordResetUserPayload' }
    & Pick<RequestPasswordResetUserPayload, 'clientMutationId'>
    & { user?: Maybe<(
      { __typename?: 'User' }
      & Pick<User, 'email' | 'id' | 'password' | 'token' | 'username'>
    )> }
...
export type ResetPasswordUserMutation = (
  ...
  & { resetPasswordUser?: Maybe<(
    { __typename?: 'resetPasswordUserPayload' }
    & Pick<ResetPasswordUserPayload, 'clientMutationId'>
    & { user?: Maybe<(
      { __typename?: 'User' }
      & Pick<User, 'email' | 'id' | 'password' | 'token' | 'username'>
    )> }
...
export type UpdateProviderMutation = (
  ...
  & { updateProvider?: Maybe<(
    { __typename?: 'updateProviderPayload' }
    & Pick<UpdateProviderPayload, 'clientMutationId'>
    & { provider?: Maybe<(
      { __typename?: 'Provider' }
      & Pick<Provider, 'id' | 'name' | 'address' | 'email' | 'phoneNumber' | 'type'>
    )> }
...
export type BiscEmployeesQuery = (
  { __typename?: 'Query' }
  & { employees?: Maybe<(
    { __typename?: 'EmployeeConnection' }
    & { edges?: Maybe<Array<Maybe<(
      ...
      & { node?: Maybe<(
        { __typename?: 'Employee' }
        & Pick<Employee, 'id' | 'givenName' | 'additionalName' | 'familyName' | 'email' | 'telephone'>
      )> }
    )>>> }
  )> }
);
...
export type LanguageHouseQuery = (
  { __typename?: 'Query' }
  & { languageHouse?: Maybe<(
    { __typename?: 'LanguageHouse' }
    & Pick<LanguageHouse, 'id' | 'name' | 'phoneNumber' | 'address' | 'email' | 'type'>
  )> }
);
...
export type LanguageHousesQuery = (
  { __typename?: 'Query' }
...
export type ProvidersQuery = (
  ...
  & { providers?: Maybe<(
    ...
    & { edges?: Maybe<Array<Maybe<(
      ...
      & { node?: Maybe<(
        { __typename?: 'Provider' }
        & Pick<Provider, 'id' | 'name' | 'phoneNumber' | 'email' | 'address' | 'type'>
      )> }
    )>>> }
  )> }
);
 ...
 * });
 */
export function useCreateLanguageHouseMutation(baseOptions?: Apollo.MutationHookOptions<CreateLanguageHouseMutation, CreateLanguageHouseMutationVariables>) {
        return Apollo.useMutation<CreateLanguageHouseMutation, CreateLanguageHouseMutationVariables>(CreateLanguageHouseDocument, baseOptions);
      }
...
export type CreateLanguageHouseMutationOptions = Apollo.BaseMutationOptions<CreateLanguageHouseMutation, CreateLanguageHouseMutationVariables>;
 ...
 * });
 */
export function useRequestPasswordResetUserMutation(baseOptions?: Apollo.MutationHookOptions<RequestPasswordResetUserMutation, RequestPasswordResetUserMutationVariables>) {
        return Apollo.useMutation<RequestPasswordResetUserMutation, RequestPasswordResetUserMutationVariables>(RequestPasswordResetUserDocument, baseOptions);
      }
...
export type RequestPasswordResetUserMutationOptions = Apollo.BaseMutationOptions<RequestPasswordResetUserMutation, RequestPasswordResetUserMutationVariables>;
...
export function useResetPasswordUserMutation(baseOptions?: Apollo.MutationHookOptions<ResetPasswordUserMutation, ResetPasswordUserMutationVariables>) {
        return Apollo.useMutation<ResetPasswordUserMutation, ResetPasswordUserMutationVariables>(ResetPasswordUserDocument, baseOptions);
      }
 ...
 * });
 */
export function useBiscEmployeesQuery(baseOptions?: Apollo.QueryHookOptions<BiscEmployeesQuery, BiscEmployeesQueryVariables>) {
        return Apollo.useQuery<BiscEmployeesQuery, BiscEmployeesQueryVariables>(BiscEmployeesDocument, baseOptions);
      }
export function useBiscEmployeesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BiscEmployeesQuery, BiscEmployeesQueryVariables>) {
 ...
 * });
 */
export function useLanguageHouseQuery(baseOptions: Apollo.QueryHookOptions<LanguageHouseQuery, LanguageHouseQueryVariables>) {
        return Apollo.useQuery<LanguageHouseQuery, LanguageHouseQueryVariables>(LanguageHouseDocument, baseOptions);
      }
export function useLanguageHouseLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LanguageHouseQuery, LanguageHouseQueryVariables>) {
 ...
 * });
 */
export function useLanguageHousesQuery(baseOptions?: Apollo.QueryHookOptions<LanguageHousesQuery, LanguageHousesQueryVariables>) {
        return Apollo.useQuery<LanguageHousesQuery, LanguageHousesQueryVariables>(LanguageHousesDocument, baseOptions);
      }
export function useLanguageHousesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LanguageHousesQuery, LanguageHousesQueryVariables>) {
