...
export const ManagementBiscEmployeesDetailUpdateView: React.FunctionComponent<Props> = props => {
    ...
    const { mutate, loading, error } = usePutOrganizationEmployee(biscEmployeeId)
            ...
            <Form onSubmit={handleEdit(employee)}>
                ...
                <Modal isOpen={modalIsVisible} onRequestClose={() => setModalIsVisible(false)}>
                    <BiscCoworkerDeleteModalView
                        ...
                        onSuccess={() => {
                            history.push(biscRoutes.management.coworkers.index)
                        }}
                    />
                </Modal>
            </Form>
    ...
    function handleEdit(employee: OrganizationEmployee) {
        return async (e: React.FormEvent<HTMLFormElement>) => {
            ...
            try {
                ...
                history.push(biscRoutes.management.coworkers.detail(employee.id).data.index)
