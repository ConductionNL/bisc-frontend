...
import { useGetSingleStudentReport, useGetStudent } from 'api/student/student'
...
export const ParticipantsDownloadDetailsView: React.FunctionComponent = () => {
    ...
    const { response: reportResponse, loading: reportLoading, error: reportError, refetch } = useGetSingleStudentReport(
    ...
    return (
        <>
            <Headline title={i18n._(t`Gegevens delen`)} spacingType={SpacingType.small} />
            <Column spacing={12}>
                <Column spacing={4}>
                    <TaalhuisParticipantDetailTabs activeTabId={TaalhuisParticipantDetailTabsEnum.DownloadDetails} />
                </Column>
